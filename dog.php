...
$sql = "SELECT * FROM pets WHERE category='Dog'";
...
<head>
  ...
  <title>PetMatch — Dogs</title>
  <meta name="description" content="Browse dogs available for sale or adoption at Pawfect Match." />
...
<body>
  ...
  <nav aria-label="User authentication"> 
    ...
    <!-- Search -->
    <form class="search" role="search" aria-label="Search dogs">
      <input type="search" name="q" placeholder="Search dogs by breed, age, or location" aria-label="Search dogs">
      <button type="submit">Search</button>
    </form>

    <!-- Categories -->
    <div class="topcategories">
      <a href="dog.php" class="active">Dogs</a>
    ...
    <!-- Hero -->
    <section class="hero hero-dog" aria-labelledby="hero-head">
      <div class="hero-overlay"></div>
      <div class="hero-content">
        <h1 id="hero-head">Meet Our Adorable Dogs 🐶</h1>
        <p>Find loyal companions ready to join your family — browse dogs for sale or adoption near you.</p>
      </div>
    </section>

    <!-- Listings -->
    <section id="listings" aria-labelledby="list-head">
      <h2 class="section-title" id="list-head">Available Dogs</h2>
      ...
      <div class="grid" id="dogGrid">
        ...
        if ($result && $result->num_rows > 0) {
          ...
          echo "<p style='text-align:center;color:#666;'>No dogs found in the database.</p>";
        }
        ?>
      </div>
    </section>
  ...
  <script>
    ...
    // Default: show shop only on load
