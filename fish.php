...
$sql = "SELECT * FROM pets WHERE category='Fish'";
...
<head>
  ...
  <title>PetMatch — Fish</title>
  <meta name="description" content="Explore colorful fish available for sale or adoption at Pawfect Match." />
...
<body>
  ...
  <nav aria-label="User authentication"> 
    ...
    <!-- SEARCH -->
    <form class="search" role="search" aria-label="Search fish">
      <input type="search" name="q" placeholder="Search by breed, size, or location — e.g. 'Goldfish Cebu'" aria-label="Search fish">
    ...
    <div class="topcategories">
      ...
      <a href="fish.php" class="active">Fish</a>
      <a href="reptiles.php">Reptiles</a>
    </div>

    <!-- HERO -->
    <section class="hero hero-fish" aria-labelledby="hero-head">
      <div class="hero-overlay"></div>
      <div class="hero-content">
        <h1 id="hero-head">Find Your Perfect Fish 🐠</h1>
        <p>From vibrant bettas to gentle goldfish, discover aquatic friends for your tank.</p>
      </div>
    </section>

    <!-- LISTINGS -->
    <section id="listings" aria-labelledby="list-head">
      <h2 id="list-head" class="section-title">Fish Listings</h2>
      ...
      <div class="grid" id="fishGrid">
        ...
        if ($result && $result->num_rows > 0) {
          ...
          echo "<p style='text-align:center;color:#666;'>No fish found in the database.</p>";
        }
        ?>
      </div>
    </section>
